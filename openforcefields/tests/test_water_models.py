...
# OpenMM determines virtual site coordinates based on atomic positions, so in order to produce
# the force field-specified geometry without integration, the positions must be initialized at
# a geometry specified by the force field.
@pytest.fixture()
